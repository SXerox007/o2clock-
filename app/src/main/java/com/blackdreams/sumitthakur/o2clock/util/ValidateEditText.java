...
import static com.blackdreams.sumitthakur.o2clock.Constants.AppConstants.REGEX_MOBILE_NUMBER;
...
public final class ValidateEditText {
    ...
    private static boolean setErrorAndRequestFoucs(final EditText et, final String errorMessage) {
        new AlertDialog.Builder(getContext(et))
                .setMessage(errorMessage)
                .setPositiveButton(R.string.text_ok, new AlertDialog.OnClickListener() {
